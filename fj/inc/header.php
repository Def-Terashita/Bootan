...
<div class="nav bg-white" id="navi">
    ...
    <nav>
        ...
        <!--<div class="nav-contact bg-red color-white">
    		<a class="color-white" href="tel:0666439305">TEL 06-6643-9305</a> / <a  class="color-white" href="<?= Fj_Form ?>">MAIL info@d-bootan.com</a>
    	</div>
