...
// サーバ種別判定
if(FALSE === strpos($_SERVER["SERVER_NAME"], "d-bootan.com"))
{
	// サーバ種別：開発・テストサーバ
...
if(Serve_Type === Deve_Test_Serve)
{
	// 開発・テストサーバ
    // SERVER : localhost
    define("Document_Root", $_SERVER["DOCUMENT_ROOT"]."/Bootan/fj/");
}
else
{
	// 運用・本番サーバ
...
//--- 送信元(from)メールアドレス ---
define("Mail_FromAdress", 		"info@d-bootan.net");
define("Smt_PortNo",            "587");
define("Mail_FromName", 		"Bootan");
define("Mail_Subj_user",		"【Bootan】自動返送メール");
define("Mail_Subj_usercomp",	"【Bootan】登録完了");
define("Mail_Subj_New",     	"【Bootan】新規登録がありました。");
define("Mail_Subj_Form",	    "【Bootan】お問い合わせが入りました。");
