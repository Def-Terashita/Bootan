...
<head>
    ...
    <meta name="description" content="Bootanのお問い合わせページです。案件について、フリーランスについて、何でもお問い合わせください">
    <title>お問い合わせ - Bootan</title>
                    	...
                    	<form action="<?= $_SERVER["SCRIPT_NAME"] ?>" method="post" class='tablewrap form_tablewrap'>
                    		...
                    		<table  class="bg-white">
                    			<tr>
                    				...
                    				<td>
                    					<select name="subject" id="form-subject">
                                        	...
                                        	<option value="フリーランスJOBSについて" <?php if($subject == "Bootanについて"){echo 'selected';}?>>Bootanについて</option>
                    			...
                    			<tr>
                    				<th>メールアドレス</th>
                    				<td>
                    					<input type="text" name="mail" value="<?= $mail ?>" size="30" placeholder=" 例）info@d-bootan.com"  />
